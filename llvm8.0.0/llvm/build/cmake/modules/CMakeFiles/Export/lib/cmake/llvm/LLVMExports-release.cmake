...
# Import target "LLVMVideoCore4CodeGen" for configuration "Release"
set_property(TARGET LLVMVideoCore4CodeGen APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(LLVMVideoCore4CodeGen PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libLLVMVideoCore4CodeGen.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMVideoCore4CodeGen )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMVideoCore4CodeGen "${_IMPORT_PREFIX}/lib/libLLVMVideoCore4CodeGen.a" )

# Import target "LLVMVideoCore4Info" for configuration "Release"
set_property(TARGET LLVMVideoCore4Info APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(LLVMVideoCore4Info PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libLLVMVideoCore4Info.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMVideoCore4Info )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMVideoCore4Info "${_IMPORT_PREFIX}/lib/libLLVMVideoCore4Info.a" )

# Import target "LLVMVideoCore4Desc" for configuration "Release"
set_property(TARGET LLVMVideoCore4Desc APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(LLVMVideoCore4Desc PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libLLVMVideoCore4Desc.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMVideoCore4Desc )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMVideoCore4Desc "${_IMPORT_PREFIX}/lib/libLLVMVideoCore4Desc.a" )

# Import target "LLVMVideoCore4AsmPrinter" for configuration "Release"
set_property(TARGET LLVMVideoCore4AsmPrinter APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(LLVMVideoCore4AsmPrinter PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libLLVMVideoCore4AsmPrinter.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMVideoCore4AsmPrinter )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMVideoCore4AsmPrinter "${_IMPORT_PREFIX}/lib/libLLVMVideoCore4AsmPrinter.a" )
