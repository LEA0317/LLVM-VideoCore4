...
set_target_properties(LLVMHello PROPERTIES
  IMPORTED_LOCATION_RELEASE "/mnt/work/my_github/LLVM-VideoCORE4/llvm8.0.0/llvm/build/lib/LLVMHello.so"
...
set_target_properties(LLVMTestingSupport PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "/mnt/work/my_github/LLVM-VideoCORE4/llvm8.0.0/llvm/build/lib/libLLVMTestingSupport.a"
  )
...
set_target_properties(FileCheck PROPERTIES
  IMPORTED_LOCATION_RELEASE "/mnt/work/my_github/LLVM-VideoCORE4/llvm8.0.0/llvm/build/bin/FileCheck"
  )
...
set_target_properties(llvm-PerfectShuffle PROPERTIES
  IMPORTED_LOCATION_RELEASE "/mnt/work/my_github/LLVM-VideoCORE4/llvm8.0.0/llvm/build/bin/llvm-PerfectShuffle"
  )
...
set_target_properties(count PROPERTIES
  IMPORTED_LOCATION_RELEASE "/mnt/work/my_github/LLVM-VideoCORE4/llvm8.0.0/llvm/build/bin/count"
  )
...
set_target_properties(not PROPERTIES
  IMPORTED_LOCATION_RELEASE "/mnt/work/my_github/LLVM-VideoCORE4/llvm8.0.0/llvm/build/bin/not"
  )
...
set_target_properties(yaml-bench PROPERTIES
  IMPORTED_LOCATION_RELEASE "/mnt/work/my_github/LLVM-VideoCORE4/llvm8.0.0/llvm/build/bin/yaml-bench"
  )
...
set_target_properties(BugpointPasses PROPERTIES
  IMPORTED_LOCATION_RELEASE "/mnt/work/my_github/LLVM-VideoCORE4/llvm8.0.0/llvm/build/lib/BugpointPasses.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(lli-child-target PROPERTIES
  IMPORTED_LOCATION_RELEASE "/mnt/work/my_github/LLVM-VideoCORE4/llvm8.0.0/llvm/build/bin/lli-child-target"
  )
...
set_target_properties(TestPlugin PROPERTIES
  IMPORTED_LOCATION_RELEASE "/mnt/work/my_github/LLVM-VideoCORE4/llvm8.0.0/llvm/build/unittests/Passes/TestPlugin.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(gtest PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "/mnt/work/my_github/LLVM-VideoCORE4/llvm8.0.0/llvm/build/lib/libgtest.a"
  )
...
set_target_properties(gtest_main PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "/mnt/work/my_github/LLVM-VideoCORE4/llvm8.0.0/llvm/build/lib/libgtest_main.a"
  )
